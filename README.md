...
[![Stable](https://img.shields.io/badge/docs-stable-blue.svg)](https://okatsn.github.io/DatabasePlayground.jl/stable/)
[![Dev](https://img.shields.io/badge/docs-dev-blue.svg)](https://okatsn.github.io/DatabasePlayground.jl/dev/)
[![Build Status](https://github.com/okatsn/DatabasePlayground.jl/actions/workflows/CI.yml/badge.svg?branch=main)](https://github.com/okatsn/DatabasePlayground.jl/actions/workflows/CI.yml?query=branch%3Amain)

<!-- Don't have any of your custom contents above; they won't occur if there is no citation. -->

## Documentation Badge is here:

[![](https://img.shields.io/badge/docs-stable-blue.svg)](https://okatsn.github.io/DatabasePlayground.jl/stable)
[![](https://img.shields.io/badge/docs-dev-blue.svg)](https://okatsn.github.io/DatabasePlayground.jl/dev)
...
!!! note Checklist
    - [ ] Create an empty repository (namely, `https://github.com/okatsn/DatabasePlayground.jl.git`) on github, and push the local to origin. See [connecting to remote](#tips-for-connecting-to-remote).
...
### Auto-Registration
- You have to add `ACCESS_OKREGISTRY` to the secret under the remote repo (e.g., https://github.com/okatsn/DatabasePlayground.jl).
...
Connect to remote:
1. Switch to the local directory of this project (DatabasePlayground)
2. Add an empty repo DatabasePlayground(.jl) on github (without anything!)
...
This package is create on 2024-04-30.
